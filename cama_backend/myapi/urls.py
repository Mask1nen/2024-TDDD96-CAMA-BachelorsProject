...
from .views import CamaUserView, StudyView, ExperimentView, EffectDataView, get_orcid_infoAPIView, \
                ...
                ImplementationOptionsView, TestTimeOptionsView, EffectSizeTypeOptionsView, StudyViewDetail, ExperimentFilterView, EffectDataFilterView, \
                StudyFilterView, StudySearchView
...
urlpatterns = [
    ...
    path('populate-study-design/', StudyDesignOptionsView.as_view(), name='populate-study-design'),
    ...
    path('studies-search/', StudySearchView.as_view(), name='studies-search')
    ]
