...
=======
# Generated by Django 4.2.10 on 2024-04-24 09:19
>>>>>>> origin/dev
...
>>>>>>> origin/dev
        ...
        migrations.CreateModel(
            ...
            options={
                'unique_together': {('k', 'first', 'second', 'third', 'forth', 'fifth', 'sixth', 'seventh', 'eighth', 'ninth', 'tenth', 'eleventh', 'twelfth')},
            },
        ),
        migrations.CreateModel(
            name='Experiment',
...
=======
                ('study_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='experiment', to='myapi.study')),
>>>>>>> origin/dev
            ],
            options={
