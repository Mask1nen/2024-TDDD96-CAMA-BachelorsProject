# Generated by Django 4.2.10 on 2024-04-12 12:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uploader', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='myapi.user')),
                ('year', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='myapi.year')),
            ],
        ),
        migrations.CreateModel(
            name='Experiment',
