        ...
        <Box>
            ...
            <Box display="flex"  justifyContent="center"  alignItems="center">
                <Box display="flex" sx={{justifyContent:"flex-start"}}>
                    ...
                    <Typography variant="h1" style={{ color: 'black' , textShadow: '2px 2px 4px rgba(0, 0, 0, 0.5)' }}> Team</Typography>
                    <img src={CAMA_test_icon} alt="Description of the image" width="250" height="250" style={{ top: '-50px', position: 'relative' }}/>                        
                </Box>
            </Box>
        ...
        <Grid container rowSpacing={8}>
            <Grid item xs={12}>
                <Paper sx={{p:3, height:'100%'}}> 
                    <p> The team behind cama is Lucija Batinovic and XXX </p> <br />
                    <p> We are very passionate about YYY </p> <br />
                </Paper>
            </Grid>
